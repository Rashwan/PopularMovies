...
import com.example.rashwan.popularmovies.provider.base.BaseContentProvider;
...
public class MoviesProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.example.rashwan.popularmovies.provider";
